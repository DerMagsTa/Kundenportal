...
<my:base>
	...
	<fmt:message key="i18n.‹berschrift_Verbrauch1"/> ${zaehler.energieArt}<fmt:message key="i18n.‹berschrift_Verbrauch2"/> ${zaehler.zaehlerNr} <br>
	<fmt:message key="i18n.‹berschrift_Verbrauch3"/> ${entnahmestelle.straﬂe} ${entnahmestelle.hausNr}, ${entnahmestelle.plz} ${entnahmestelle.ort}
	</jsp:attribute>
