		...
		<ul>
			<c:forEach items="${pdbuffer.es}" var="e">
				...
				<p><a href="<c:url value="/entnahmestelle.html?eid=${e.id}"/>"><button type="button" class="btn btn-warning btn-xs"><fmt:message key="i18n.Entnahmestelle-ändern"/></button></a>
					<a href="<c:url value="/zaehler.html?eid=${e.id}"/>"><button type="button" class="btn btn-success btn-xs"><fmt:message key="i18n.Zaehler-hinzufügen"/></button></a>
					</p>
				...
				<c:forEach items="${e.zaehler}" var="z">
					<tr>
						...
						<td style="width: 50px"><a href="<c:url value="/zaehler.html?zid=${z.id}"/>"><button type="button" class="btn btn-warning btn-xs"><fmt:message key="i18n.ändern"/></button></a></td>
