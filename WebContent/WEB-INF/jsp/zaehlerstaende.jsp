...
<my:base>
	...
	<fmt:message key="i18n.Titel_Z‰hlerst‰nde"/>
	</jsp:attribute>
	<jsp:attribute name="headline">
	<fmt:message key="i18n.‹berschrift_Z‰hlerst‰nde1"/> ${zaehler.energieArt}<fmt:message key="i18n.‹berschrift_Z‰hlerst‰nde2"/> ${zaehler.zaehlerNr} <br>
	<fmt:message key="i18n.‹berschrift_Z‰hlerst‰nde3"/> ${entnahmestelle.straﬂe} ${entnahmestelle.hausNr}, ${entnahmestelle.plz} ${entnahmestelle.ort}
	</jsp:attribute>
	<jsp:body>
	...
	<script type="text/javascript">
		...
		function getMesswerte() {
			$.ajax({
				...
				$.each(data, function(i, m) {
					...
					html += "<td>" + "<a href='${pageContext.request.contextPath}/zaehlerstaende.html?zid=" + getUrlParameter("zid") + "&eid=" + getUrlParameter("eid") +"&mid=" + m.id + "'><button type='button' class='btn btn-success btn-xs'><fmt:message key='i18n.‰ndern'/></button></a>" + "</td>";
					html += "<td>" + "<a href='${pageContext.request.contextPath}/zaehlerstaende.html?zid=" + getUrlParameter("zid") + "&eid=" + getUrlParameter("eid") +"&mid=" + m.id + "&del=true" + "'><button type='button' class='btn btn-danger btn-xs'><fmt:message key='i18n.lˆschen'/></button></a>" + "</td></tr>";
				});
		...
		<div class="container">
			...
			<form class="form-inline" method="post">
				...
				<div class="form-group">
					<label for="messwert"><fmt:message key="i18n.Z‰hlerstand" /> (<fmt:message key="i18n.Z‰hlerstand_Einheit_${unit}" />)</label> 
		...
		<table id="Messwerte" class="table table-hover" style="margin-top: 20px; max-width: 400px;">
			<thead>
				<tr>
					...
					<th><fmt:message key="i18n.Z‰hlerstand" /> (<fmt:message key="i18n.Z‰hlerstand_Einheit_${unit}" />)</th>
					<th></th>
				</tr>
			</thead>
			<tbody>
